...
import { injectSchema, generateBookSchema, clearSchemas } from "@/utils/schema";

export default function Books() {
  useEffect(() => {
    setMetadata(pageMetadata.books);
    clearSchemas();
    // Optionally expose first book as structured data for rich results
    if (books[0]) {
      injectSchema(
        generateBookSchema({
          title: books[0].title,
          ...
          image: undefined,
          publishedDate: books[0].publishedYear?.toString?.(),
        }),
      );
    }
  }, []);
    ...
    <div className="container py-12 animate-fade-in">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-muted-foreground mb-12">
          Words bound together, stories that transform.
        </p>
          ...
          {books.map((book, index) => (
            ...
            >
              ...
              <div className="md:w-2/3">
                ...
                <h2 className="font-serif text-3xl font-semibold mt-1 mb-2">
                  {book.title}
                </h2>
                {book.subtitle && (
        ...
        <section className="mt-20 pt-12 border-t">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {books
              .flatMap((book) => book.testimonials)
