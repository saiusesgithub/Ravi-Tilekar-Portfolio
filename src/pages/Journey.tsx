  ...
  return (
    <div className="container py-12 animate-fade-in">
      <div className="max-w-4xl mx-auto">
        <h1 className="font-serif text-4xl font-semibold mb-2">Professional Journey</h1>
        <p className="text-muted-foreground mb-12">From intern to founder — a path of continuous building and learning.</p>
        ...
        <div className="relative">
          ...
          {journeyMilestones.map((milestone, index) => (
            <div key={milestone.id} className={`relative flex flex-col md:flex-row gap-8 mb-12 ${index % 2 === 0 ? 'md:flex-row' : 'md:flex-row-reverse'}`}>
              {/* Timeline Dot */}
                ...
                <Card className="card-hover">
                  <CardContent className="p-6">
                    <div className="flex items-center gap-2 mb-2 flex-wrap">
                      ...
                      {milestone.current && <Badge variant="secondary">Current</Badge>}
                    </div>
                    <h3 className="font-serif text-xl font-semibold mb-1">{milestone.organization}</h3>
                    <p className="text-primary font-medium mb-3">{milestone.role}</p>
