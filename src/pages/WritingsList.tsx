...
export default function WritingsList() {
  ...
  useEffect(() => {
    const titleSuffix = categoryInfo?.label ? ` – ${categoryInfo.label}` : "";
    setMetadata({
      ...pageMetadata.writings,
      title: `Writings${titleSuffix} | Ravi Tilekar`,
      description:
        categoryInfo?.description || pageMetadata.writings.description,
    });
  }, [categoryInfo]);
